<header>
    <section class="sec-topbar doctor-header nz-uk">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6 col-sm-6 contact-info">
                    <ul>
                        <li><a href="mailto:helpdesk@themedfuture.com">
                                <p>helpdesk@themedfuture.com</p>
                            </a></li>
                        <li><a href="tel:+442045387274">
                                <p>+44 20 4538 7274 (International)</p>
                            </a></li>
                        <li><a href="tel:+442045387274">
                                <p>+44 20 4538 7274 (local)</p>
                            </a></li>
                    </ul>
                </div>
        ...
        <div class="container padd-0">
            ...
            <div class="collapse navbar-collapse navbar-inner" id="navbarScroll">
                <ul class="navbar-nav navbar-nav-scroll">
                    <li class="nav-item">
                        <a class="nav-link nav-link-nz-uk" aria-current="page" href="#">Home</a>
                        <!-- <div class="home-dropdown-list"> -->
                        <ul class="dropdown-list nz-uk">
                            <li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-nz-uk" href="UK-Medfuture-job-page-perm.html">Jobs</a>
                        <div class="jobs-list nz-uk">
                                ...
                                <li class="jobs-list-dropdown-list-first">
                                    ...
                                    <div class="list-nsw">
                                        <ul class="jobs-dropdown-dtil-1">
                                            ...
                                            <li><a href="#">Glasgo</a> </li>
                                            <li><a href="#">Aberdeen</a> </li>
                                            <li><a href="#">Dundee</a> </li>
                                            <li><a href="#">Striling</a> </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-nz-uk" href="#">Candidates</a>
                        <div class="jobs-list candidat-list nz-uk">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-permanent" role="tabpanel"
                                    ...
                                    <ul class="jobs-dropdown-dtil">
                                        <li><a href="UK-Doctor-Medfuture-Overseas_AU_1.html">Doctors or General
                                                Practitioners</a> </li>
                                        <li><a href="UK-Nurses-and-Midwives-1.html">Nurses I Care Workers I Midwife
                                            </a> </li>
                                        <li><a href="UK-Medfuture-AHP_AU_1.html">Allied Health Professional </a>
                                        </li>
                                        <li><a href="UK-Medfuture-Healthcare-Executives_au1.html">Healthcare
                                                Executives </a> </li>
                                        <li><a href="{{route('nz_candidate_registration')}}">Create an Account
                                            </a> </li>
                                        <li class="refer-reward" path="v-pills-refer"><a href="UK-Doctor-Medfuture-Overseas_AU_2.html">Refer & Earn Reward </a> </li>
                                    </ul>
                                </div>
                                <div class="tab-pane fade" id="pills-locum" role="tabpanel"
                                    ...
                                    <ul class="jobs-dropdown-dtil">
                                        ...
                                        <li  class="refer-reward" path="v-pills-refer"><a href="UK-Doctor-Medfuture-Overseas_AU_2.html">Refer & Earn Reward
                                            </a> </li>
                                ...
                                <div class="tab-pane fade" id="pills-international" role="tabpanel"
                                    ...
                                    <ul class="jobs-dropdown-dtil">
                                        <li><a href="AUS-Doctor-Medfuture-Overseas_AU_1.html">Doctors or General Practitioners - Australia</a> </li>
                                        <li><a href="AUS-Nurses-and-Midwives-1.html">Nurses I Care Workers I Midwife - Australia</a> </li>
                                        <li><a href="AUS-Medfuture-AHP_AU_1.html">Allied Health Professional - Australia</a></li>
                                        <li><a href="AUS-Medfuture-Healthcare-Executives_au1.html">Healthcare Executives - Australia</a> </li>
                                        <li><a href="NZ-Doctor-Medfuture-Overseas_AU_1.html">Doctors or General Practitioners Jobs - New Zealand </a> </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-nz-uk" href="#">Employer</a>
                        <ul class="dropdown-list nz-uk">
                            <li>
                                <a href="UK-Doctor-PermanentAu.html">Permanent Staffing Solution</a>
                            </li>
                            <li>
                                <a href="UK-Doctor-LocumAu.html">Locum Staffing Solution</a>
                            </li>
                            <li>
                                <a href="UK-Medfuture-Employer-dropdown-create-your-account.html">Create An
                                    Account</a>
                            </li>
                            <li>
                                <a href="UK-Medfuture-Employer-dropdown-submit-your-vacancy.html">Submit Your
                                    Vacancy</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-nz-uk" href="https://www.medfuture.com.au/blog">Blog</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-nz-uk" href="UK-contact-us.html">Contact</a>
                    </li>
                </ul>
            </div>
