        ...
        <div class="container padd-0">
            ...
            <div class="collapse navbar-collapse navbar-inner" id="navbarScroll">
                <ul class="navbar-nav navbar-nav-scroll">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-permanent" role="tabpanel"
                                    ...
                                    <ul class="jobs-dropdown-dtil">
                                        <li  class="permanent" path="v-pills-permanent"><a href="AUS-Doctor-Medfuture-Overseas_AU_1.html">Doctors or General
                                                Practitioners</a> </li>
                                        ...
                                        <li><a href="AUS-Medfuture-Healthcare-Executives_au1.html">Healthcare
                                                Executives </a> </li>
                                        <li><a href="{{route('aus.candidate.registration')}}">Create an Account
                                            </a> </li>
                                ...
                                <div class="tab-pane fade" id="pills-locum" role="tabpanel"
                                    ...
                                    <ul class="jobs-dropdown-dtil">
                                        ...
                                        <li><a href="AUS-Doctor-Medfuture-Overseas_AU_2.html">Refer & Earn Reward
                                            </a> </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="AUS-contact-us.html">Contact</a>
                    </li>
                </ul>
            </div>
