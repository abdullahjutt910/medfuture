@extends('frontend.aus_layout.master')
@section('content')
<div class="sec-doctor-banner">
    <div class="container" style="padding: 0;">
        <div class="bannerData">
            <h1>Empowering Healthcare Professionals</h1>
            <a href="AUS-Medfuture-Candidate-Registration.html"><button><span>Rigester with us</span><img
...
<section class="register-section">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12 register-section-right">
                <div class="registerSectionInner">
                    ...
                    </a> <a href="AUS-Doctor-Medfuture-Overseas_AU_2.html">
                        <div  class="register-detail-inner">
