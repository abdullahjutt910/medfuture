...
<body>
    <!-- header starts  here-->
    @include('frontend.nz_layout.header')
    <!-- header end here -->
   ...
   <!-- footer-->
   @include('frontend.nz_layout.footer')
   <!-- footer end here-->


    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="{{ asset('css/bootstrap/dist/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('css/slick-1.8.1/slick/slick.js') }}"></script>
    <script src="{{ asset('css/slick-1.8.1/slick/slick.min.js') }}"></script>
