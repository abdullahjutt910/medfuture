@extends('frontend.nz_layout.master')
@section('content')
<div class="sec-doctor-banner">
        <div class="container" style="padding: 0;">
            <div class="bannerData">
                <h1>Empowering Healthcare Professionals</h1>
                <a href="NZ-Medfuture-Candidate-Registration.html"><button><span>Rigester with us</span><img
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 register-section-right nz-uk">
                    <div class="registerSectionInner">
                        <a href="NZ-Medfuture-Candidate-Registration.html">
                        ...
                        <a href="NZ-Medfuture-job-page-perm.html">
                        ...
                        </a> <a href="NZ-Doctor-Medfuture-Overseas_AU_2.html">
                            <div class="register-detail-inner">
