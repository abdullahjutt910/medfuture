@extends('frontend.nz_layout.candidate_registration.master')
@section('content')
<main>
         ...
         <div class="forms-col">
             <div class="form-col-right">
                 <div class="row">
                     <div class="padd-0">
                         <div class="registration-form">
                             <form class="row registration-form-inner"  method="POST"  action="{{route('store')}}" enctype="multipart/form-data">
                                @csrf
