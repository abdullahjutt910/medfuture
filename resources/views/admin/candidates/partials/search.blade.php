          ...
          <div class="search-filter-top">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="search-filter-top-right">
                                <a href="{{route('admin.filter.candidates')}}/{{request('slug') ? request('slug') : 'all' }}/pdf" class="btn print-btn">Print</a>
                                <a href="{{route('admin.filter.candidates')}}/{{request('slug') ? request('slug') : 'all' }}/excel" class="btn excel-btn">Excel</a>
            ...
            <form method="GET" style="padding: 10px ; margin: 10px">
                            ...
                            <div class="col-md-12 first-top-field">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <!-- <label class="" for="first_name">{{ trans('cruds.candidate.fields.first_name') }}</label> -->
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <!-- <label class="" for="last_name">{{ trans('cruds.candidate.fields.last_name') }}</label> -->
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <!-- <label class="">{{ trans('cruds.candidate.fields.gender') }}</label> -->
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <!-- <label class="" for="home">{{ trans('cruds.candidate.fields.home') }}</label> -->
                                            <input class="form-control" type="text" name="home" id="home"
                                                   placeholder="Home" value="{{ old('home', '') }}" >
                                            @if($errors->has('home'))
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <!-- <label class="" for="work">{{ trans('cruds.candidate.fields.work') }}</label> -->
                                            <input class="form-control" type="text" name="work" id="work"
                                                   placeholder="Work" value="{{ old('work', '') }}" >
                                            @if($errors->has('work'))
                    ...
                    <div class="row p-3">
                                ...
                                <!-- <label>{{ trans('cruds.candidate.fields.devision') }}</label> -->
                                    <select class="form-control" name="devision" id="devision">
                                        ...
                                        @foreach(App\Models\Candidate::DEVISION_SELECT as $key => $label)
                                             <option value="{{ $key }}" {{ old('devision', request('devision') )===(string) $key
                                                    ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    <i class="fas fa-sort-down"></i>
                            ...
                            <div class="col-md-3">
                                <div
                                    class="form-group {{ $errors->has('exp

erience_from_home') ? 'has-error' : '' }}">
