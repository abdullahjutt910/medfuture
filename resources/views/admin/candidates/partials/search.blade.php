                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="search-filter-top-right">
                                ...
                                <button class="btn excel-btn">Excel</button>
                ...
                <div class="hide-show">
                    <div class="search-filter-form-inner">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select class="form-control form-select-lg mb-3" name="state"
                                        aria-label=".form-select-lg example">
                                        <option value="" disabled="" selected="">State</option>
                                        <option value="New South Wales (NSW)">New South Wales (NSW)</option>
                                        <option value="Australian Capital Territory (ACT)">Australian Capital Territory
                                            (ACT)</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select class="form-control form-select-lg mb-3" name="cv_document"
                                        aria-label=".form-select-lg example">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="privacy_term"
                                        placeholder="Privacy Term">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select class="form-control form-select-lg mb-3" name="source_name"
                                        ...
                                        <option value="Medfuture Direct Registration">Medfuture Direct Registration
                                        </option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="registration_type"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="visa_status"
                                        placeholder="Visa Status">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select class="profession-doctor form-control form-select-lg mb-3" name="profession"
                                        aria-label=".form-select-lg example">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="professional_qualification"
                                        placeholder="Prof Qualification">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select class="form-control form-select-lg mb-3" name="employment_type"
                                        aria-label=".form-select-lg example">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select class="form-control form-select-lg mb-3" name="status"
                                        aria-label=".form-select-lg example">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input class="form-control" type="date" name="created-at"
