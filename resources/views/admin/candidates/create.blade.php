                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.candidates.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('home') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="home" id="home" value="{{ old('home', '') }}" required>
                            @if($errors->has('home'))
                        ...
                        <div class="form-group {{ $errors->has('work') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="work" id="work" value="{{ old('work', '') }}" required>
                            @if($errors->has('work'))
                        ...
                        <div class="form-group {{ $errors->has('distance_to_main') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="distance_to_main" id="distance_to_main" value="{{ old('distance_to_main', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('medical_school') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="medical_school" id="medical_school" value="{{ old('medical_school', '') }}">
