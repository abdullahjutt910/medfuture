                        ...
                        <form method="POST" action="{{ route('admin.jobs.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group {{ $errors->has('company_name') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="company_name" id="company_name">
                                    <option value disabled {{ old('company_name', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::COMPANY_NAME_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('company_name', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('devision') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="devision" id="devision">
                                    ...
                                    @foreach (App\Models\Job::DEVISION_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('devision', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('cetagory') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="cetagory" id="cetagory">
                                    ...
                                    @foreach (App\Models\Job::CETAGORY_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('cetagory', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('bussiness_service') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="bussiness_service" id="bussiness_service">
                                    <option value disabled
                                        {{ old('bussiness_service', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::BUSSINESS_SERVICE_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('bussiness_service', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('bussiness_service'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('bussiness_service') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.bussiness_service_helper') }}</span>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('suburb') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="suburb" id="suburb">
                                    ...
                                    @foreach (App\Models\Job::SUBURB_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('suburb', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="country" id="country">
                                    ...
                                    @foreach (App\Models\Job::COUNTRY_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('country', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('district') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="district" id="district">
                                    ...
                                    @foreach (App\Models\Job::DISTRICT_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('district', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('distance_to_main_city') ? 'has-error' : '' }}">
                                <label
                                    for="distance_to_main_city">{{ trans('cruds.job.fields.distance_to_main_city') }}</label>
                                <input class="form-control" type="text" name="distance_to_main_city"
                                    id="distance_to_main_city" value="{{ old('distance_to_main_city', '') }}">
                                @if ($errors->has('distance_to_main_city'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('distance_to_main_city') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.distance_to_main_city_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('main_city') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="main_city" id="main_city">
                                    ...
                                    @foreach (App\Models\Job::MAIN_CITY_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('main_city', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('google_address_link') ? 'has-error' : '' }}">
                                <label
                                    for="google_address_link">{{ trans('cruds.job.fields.google_address_link') }}</label>
                                <input class="form-control" type="text" name="google_address_link"
                                    id="google_address_link" value="{{ old('google_address_link', '') }}">
                                @if ($errors->has('google_address_link'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('google_address_link') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.google_address_link_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('corporate_brand') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="corporate_brand" id="corporate_brand"
                                    value="{{ old('corporate_brand', '') }}">
                                @if ($errors->has('corporate_brand'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('corporate_brand') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.corporate_brand_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('ownership_type') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="ownership_type" id="ownership_type">
                                    <option value disabled {{ old('ownership_type', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::OWNERSHIP_TYPE_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('ownership_type', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('ownership_type'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('ownership_type') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.ownership_type_helper') }}</span>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('profession') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="profession" id="profession">
                                    ...
                                    @foreach (App\Models\Job::PROFESSION_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('profession', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('division') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="division" id="division">
                                    ...
                                    @foreach (App\Models\Job::DIVISION_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('division', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('specialty') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="specialty" id="specialty">
                                    ...
                                    @foreach (App\Models\Job::SPECIALTY_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('specialty', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('seniority') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="seniority" id="seniority">
                                    ...
                                    @foreach (App\Models\Job::SENIORITY_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('seniority', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('skills') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="skills" id="skills">
                                    ...
                                    @foreach (App\Models\Job::SKILLS_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('skills', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('placement_type') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="placement_type" id="placement_type">
                                    <option value disabled {{ old('placement_type', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::PLACEMENT_TYPE_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('placement_type', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('placement_type'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('placement_type') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.placement_type_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('engagment_term') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="engagment_term" id="engagment_term">
                                    <option value disabled {{ old('engagment_term', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::ENGAGMENT_TERM_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('engagment_term', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('engagment_term'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('engagment_term') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.engagment_term_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('employment_type') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="employment_type" id="employment_type">
                                    <option value disabled
                                        {{ old('employment_type', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::EMPLOYMENT_TYPE_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('employment_type', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('employment_type'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('employment_type') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.employment_type_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('gross_salary') ? 'has-error' : '' }}">
                                ...
                                @if ($errors->has('gross_salary'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('gross_salary') }}</span>
                                @endif
                            ...
                            <div class="form-group {{ $errors->has('gross_salary_information') ? 'has-error' : '' }}">
                                <label
                                    for="gross_salary_information">{{ trans('cruds.job.fields.gross_salary_information') }}</label>
                                <input class="form-control" type="text" name="gross_salary_information"
                                    id="gross_salary_information" value="{{ old('gross_salary_information', '') }}">
                                @if ($errors->has('gross_salary_information'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('gross_salary_information') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.gross_salary_information_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('billing_share') ? 'has-error' : '' }}">
                                ...
                                @if ($errors->has('billing_share'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('billing_share') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.billing_share_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('billing_share_information') ? 'has-error' : '' }}">
                                <label
                                    for="billing_share_information">{{ trans('cruds.job.fields.billing_share_information') }}</label>
                                <input class="form-control" type="text" name="billing_share_information"
                                    id="billing_share_information" value="{{ old('billing_share_information', '') }}">
                                @if ($errors->has('billing_share_information'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('billing_share_information') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.billing_share_information_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('hourly_rate') ? 'has-error' : '' }}">
                                ...
                                @if ($errors->has('hourly_rate'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('hourly_rate') }}</span>
                                @endif
                            ...
                            <div class="form-group {{ $errors->has('hourly_rate_information') ? 'has-error' : '' }}">
                                <label
                                    for="hourly_rate_information">{{ trans('cruds.job.fields.hourly_rate_information') }}</label>
                                <input class="form-control" type="text" name="hourly_rate_information"
                                    id="hourly_rate_information" value="{{ old('hourly_rate_information', '') }}">
                                @if ($errors->has('hourly_rate_information'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('hourly_rate_information') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.hourly_rate_information_helper') }}</span>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('post_date') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control date" type="text" name="post_date" id="post_date"
                                    value="{{ old('post_date') }}">
                            ...
                            <div class="form-group {{ $errors->has('priority_status') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="priority_status" id="priority_status">
                                    <option value disabled
                                        {{ old('priority_status', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::PRIORITY_STATUS_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('priority_status', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('priority_status'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('priority_status') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.priority_status_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('commencement_date') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control date" type="text" name="commencement_date"
                                    id="commencement_date" value="{{ old('commencement_date') }}">
                                @if ($errors->has('commencement_date'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('commencement_date') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.commencement_date_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('finished_date') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control date" type="text" name="finished_date" id="finished_date"
                                    value="{{ old('finished_date') }}">
                                @if ($errors->has('finished_date'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('finished_date') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.finished_date_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('recruitment_consultant') ? 'has-error' : '' }}">
                                <label
                                    for="recruitment_consultant">{{ trans('cruds.job.fields.recruitment_consultant') }}</label>
                                <input class="form-control" type="text" name="recruitment_consultant"
                                    id="recruitment_consultant" value="{{ old('recruitment_consultant', '') }}">
                                @if ($errors->has('recruitment_consultant'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('recruitment_consultant') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.recruitment_consultant_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('contact_number') ? 'has-error' : '' }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.contact_number_helper') }}</span>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('terms_and_condition') ? 'has-error' : '' }}">
                                <label
                                    for="terms_and_condition">{{ trans('cruds.job.fields.terms_and_condition') }}</label>
                                ...
                                @if ($errors->has('terms_and_condition'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('terms_and_condition') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.terms_and_condition_helper') }}</span>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('client_manager') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="client_manager" id="client_manager">
                                    <option value disabled {{ old('client_manager', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::CLIENT_MANAGER_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('client_manager', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('client_manager'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('client_manager') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.client_manager_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('recruitment_consultant_2') ? 'has-error' : '' }}">
                                <label
                                    for="recruitment_consultant_2">{{ trans('cruds.job.fields.recruitment_consultant_2') }}</label>
                                <input class="form-control" type="text" name="recruitment_consultant_2"
                                    id="recruitment_consultant_2" value="{{ old('recruitment_consultant_2', '') }}">
                                @if ($errors->has('recruitment_consultant_2'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('recruitment_consultant_2') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.recruitment_consultant_2_helper') }}</span>
                            </div>
                            <div class="form-group {{ $errors->has('data_administrator') ? 'has-error' : '' }}">
                                ...
                                <select class="form-control" name="data_administrator" id="data_administrator">
                                    <option value disabled
                                        {{ old('data_administrator', null) === null ? 'selected' : '' }}>
                                        {{ trans('global.pleaseSelect') }}</option>
                                    @foreach (App\Models\Job::DATA_ADMINISTRATOR_SELECT as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('data_administrator', '') === (string) $key ? 'selected' : '' }}>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('data_administrator'))
                                    <span class="help-block"
                                        role="alert">{{ $errors->first('data_administrator') }}</span>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.job.fields.data_administrator_helper') }}</span>
                            </div>
