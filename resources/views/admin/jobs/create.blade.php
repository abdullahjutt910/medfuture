                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div
                                            ...
                                            <input class="form-control" type="text" name="corporate_brand"
                                                id="corporate_brand" value="{{ old('corporate_brand', '') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('gross_salary') ? 'has-error' : '' }}">
                                            ...
                                            <input class="form-control" type="number" name="gross_salary"
                                                id="gross_salary" value="{{ old('gross_salary', '') }}" step="0.01">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('billing_share') ? 'has-error' : '' }}">
                                            ...
                                            <input class="form-control" type="text" name="billing_share"
                                                id="billing_share" value="{{ old('billing_share', '') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('finished_date') ? 'has-error' : '' }}">
                                            ...
                                            <input class="form-control date" type="text" name="finished_date"
                                                id="finished_date" value="{{ old('finished_date') }}">
                ...
                <div class="pink"></div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('recruitment_consultant_2') ? 'has-error' : '' }}">
                            ...
                            <span class="help-block" role="alert">{{ $errors->first('recruitment_consultant_2')
                                }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.job.fields.recruitment_consultant_2_helper')
                                }}</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('data_administrator') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="data_administrator" id="data_administrator">
                                <option value disabled {{ old('data_administrator', null)===null ? 'selected' : '' }}>
                                    {{ trans('global.pleaseSelect') }}</option>
