    ...
    @if(isset($questions))
        @foreach($questions as $question)
            ...
            <div class="form-group col-md-5 {{ $errors->has('question') ? 'has-error' : '' }}">
                ...
                <input class="form-control" type="text" name="question[]" id="question" value="{{ old('question', isset($question) ? $question->question : '') }}">
            ...
            <div class="form-group col-md-5 {{ $errors->has('answer') ? 'has-error' : '' }}">
                ...
                <input class="form-control" type="text" name="answer[]" id="answer" value="{{ old('answer', isset($question) ? $question->answer :'') }}">
